 ...
 */
func useEratosthenes(rangeStart int, rangeEnd int) int {
	var resultCnt int
 ...
 */
func useSquareRoot(rangeStart int, rangeEnd int) int {
	var resultCnt int
...
func main() {
	...
	for {
		...
		// writer.WriteString(strconv.Itoa(useSquareRoot(N+1, 2*N)))
		writer.WriteString(strconv.Itoa(useEratosthenes(N+1, 2*N)))
		writer.WriteByte('\n')
